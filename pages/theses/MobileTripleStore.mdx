...
While triple stores are well established on desktop and server plattforms, there are no production ready triple stores available on mobile plattforms. 
...
* write a simple wrapper app that allows to load data, run a list of queries for benchmarking and run single queries.
...
* Experience with App developement for Android and/or iOS
