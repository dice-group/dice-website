...
- [Java developer in the GERBIL project](/jobs/StudentAssistant-Java-Gerbil)
- [Java developer in the TeBaQA project](/jobs/StudentAssistant-Java-TeBaQA) (Question Answering)
- [Python developer in the Ontolearn project](/jobs/StudentAssistant-Python-Ontolearn)
- [Python developer in the PORQUE project](/jobs/StudentAssistant-Python-PORQUE) (Question Answering)
- Java/JavaScript developer: For more details and application contact [Mohamed Sherif](/MohamedAhmedSherif).
- Python developer: For more details and application contact [Stefan Heindorf](/StefanHeindorf).
