...
- [C++ developer (Tensors)](/jobs/StudentAssistant-CPP-Tensors)
- [Java developer in the GERBIL project (Benchmarking)](/jobs/StudentAssistant-Java-Gerbil)
- [Java developer in the TeBaQA project (Question Answering)](/jobs/StudentAssistant-Java-TeBaQA)
- [Python developer (Machine Learning)](/jobs/StudentAssistant-Python-Machine-Learning)
- [Python developer in the Ontolearn project (Documentation)](/jobs/StudentAssistant-Python-Ontolearn)
- [Python developer in the PORQUE project (Question Answering)](/jobs/StudentAssistant-Python-PORQUE)
- Java/JavaScript developer: For more details and application contact [Mohamed Sherif](/MohamedAhmedSherif).
