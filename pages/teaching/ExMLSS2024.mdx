...
To better understand explainability for ML models, this seminar will explore the existing approaches within the context of machine learning models applied to knowledge graphs and description logics. In particular, we will focus on (1) Class expression learning, (2) Argumentation and dialogue-based approaches, and (3) Abduction.
