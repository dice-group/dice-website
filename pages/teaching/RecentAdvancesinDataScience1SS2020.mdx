---
date: '2020-04-01'
title: 'Recent advances in Data Science - RADS1'
type: 'Seminar'
year: '2020'
term: 'Summer'
kind: 'Master'
...
Every student will take an assessment exam in the first week to be able to continue studying in the seminar. The assessment exam is for evaluating their previous computer science knowledge acquired in bachelor's. In case the student fails, they are automatically removed from the seminar. 

Afterward, the students’ performance will be evaluated as follows:
...
[L.079.08010 Seminar: Recent Advances in Data Science 1 (in English)](https://paul.uni-paderborn.de/scripts/mgrqispi.dll?APPNAME=CampusNet&PRGNAME=COURSEDETAILS&ARGUMENTS=-N625984636181075,-N000359,-N000000000000000,-N373866162574179,-N373866162581180,-N0,-N0)
