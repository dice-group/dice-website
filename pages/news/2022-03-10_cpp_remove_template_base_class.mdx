# Remove a template base class at compile time 
...
I checked this trick today against `Clang-12` and it seems like clang now can look through this construct and by that it _will_ break all code using this trick. 
