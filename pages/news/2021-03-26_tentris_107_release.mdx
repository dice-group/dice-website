...
In the [paper](https://tentris.dice-research.org/) out analysis showed that <span style="font-variant:small-caps;">Tentris</span>  was fastest for queries with large results but fell behind for some queries with large results. 
